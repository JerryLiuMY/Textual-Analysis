...
def fit_doc2vec(df_rich, doc_cut, params):
    ...
    doc2vec = Doc2Vec(doc_tag, min_count=1, window=window, vector_size=vector_size, sample=1e-3, workers=4)
    doc2vec.train(doc_tag, total_examples=doc2vec.corpus_count, epochs=10)
